document.addEventListener("DOMContentLoaded", () => {
  ...
  Promise.all([fetch("/projects/home/nginx/frontend/public/data/filters.csv").then((response) => response.text()), fetch("/projects/home/nginx/frontend/public/data/values.csv").then((response) => response.text())])
